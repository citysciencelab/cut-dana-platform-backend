...
// POST
router.post("/add/story", stories_controller.createStory);
router.post("/add/step/:story_id/:step_major/:step_minor", steps_controller.createStep);
...
// DELETE
router.delete("/delete/story/:story_id", stories_controller.deleteStory);
